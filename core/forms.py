...
class AddressForm(forms.ModelForm):
    class Meta:
        model = Address
        fields = [
            'first_name', 'last_name', 'email', 'address', 'address2', 'country', 'state', 'zip_code', 'message', 'save_info'
        ]
        widgets = {
            ...
            'save_info': forms.CheckboxInput(attrs={'class': 'form-check-input', 'id': 'save-info'}),
        }
